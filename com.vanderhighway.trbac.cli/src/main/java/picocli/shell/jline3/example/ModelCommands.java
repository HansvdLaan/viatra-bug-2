 ...
 * @since 4.1.2
 */
public class ModelCommands implements CommandRegistry {
    private final Supplier<Path> workDir;
    private final CommandLine cmd;
    private final Set<String> commands;
    private final Map<String,String> aliasCommand = new HashMap<>();

    public ModelCommands(Path workDir, CommandLine cmd) {
        this(() -> workDir, cmd);
    }

    public ModelCommands(Supplier<Path> workDir, CommandLine cmd) {
