...
import com.vanderhighway.trbac.model.trbac.model.SecurityZone;
...
public class SecurityZoneVertexTopologySmell {
    private String colour;
    private String label;


    public SecurityZoneVertexTopologySmell() {
    }

    public SecurityZoneVertexTopologySmell(SecurityZone zone) {
