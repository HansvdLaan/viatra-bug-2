...
public class TemporalContextsToDayScheduleInstances {
    ...
    public void basicAddRanges1() throws InvocationTargetException, ModelManipulationException {
        ...
        List<DayScheduleTimeRange> timeRanges = monday.getInstances().stream().
    ...
    public void basicAddRangesTrebla() throws InvocationTargetException, ModelManipulationException {
        ...
        DayOfWeekSchedule monday = (DayOfWeekSchedule) emptyScheduleResource.getEObject("Monday");
        DayOfWeekSchedule friday = (DayOfWeekSchedule) emptyScheduleResource.getEObject("Friday");
        DayOfWeekSchedule saturday = (DayOfWeekSchedule) emptyScheduleResource.getEObject("Saturday");
        DayOfMonthSchedule december5 = (DayOfMonthSchedule) emptyScheduleResource.getEObject("5_December");
        ...
        List<DayScheduleTimeRange> timeRangesMonday = monday.getInstances().stream().
                sorted(Comparator.comparingInt(TimeRange::getStart)).collect(Collectors.toList());
        ...
        List<DayScheduleTimeRange> timeRangesFriday = friday.getInstances().stream().
                sorted(Comparator.comparingInt(TimeRange::getStart)).collect(Collectors.toList());
        ...
        List<DayScheduleTimeRange> timeRangesSaturday = saturday.getInstances().stream().
                sorted(Comparator.comparingInt(TimeRange::getStart)).collect(Collectors.toList());
        ...
        List<DayScheduleTimeRange> timeRangesDecember5 = december5.getInstances().stream().
                sorted(Comparator.comparingInt(TimeRange::getStart)).collect(Collectors.toList());
    ...
    public static void assertEqualsDSTR(int expectedStartTime, int expectedEndTime, List<String> expectedTemporalContexts, DayScheduleTimeRange actualTimeRange) {
