...
import com.vanderhighway.trbac.patterns.AuthenticationStatus;
...
public class ScheduleRoutineTemporalContext {
    ...
    public ScheduleRoutineTemporalContext(AuthenticationStatus status){
        ...
        this.intervals.put("Mon", new HashSet<>());
        this.intervals.put("Tue", new HashSet<>());
        this.intervals.put("Wed", new HashSet<>());
        this.intervals.put("Thu", new HashSet<>());
        this.intervals.put("Fri", new HashSet<>());
        this.intervals.put("Sat", new HashSet<>());
        this.intervals.put("Sun", new HashSet<>());
    }
    ...
    public static Set<ScheduleRoutineTemporalContext> extractFromScheduleRoutine (ScheduleRoutine routine) {
        ...
        Set<ScheduleRoutineTemporalContext> returnSet = new HashSet<>();
